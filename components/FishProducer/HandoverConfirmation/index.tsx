...
export default function HandoverConfirmation() {
  const [handoverData, setHandoverData] = useState<HandoverData>({
    ...
    signature: null,
    additionalNotes: "",
    handoverDate: getLocalDateString(new Date()),
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex">
                    ...
                    <Input
                      ...
                      value={handoverData.recipientInfo.phoneNumber.replace(
                        /^\+?20/,
                        ""
                      )}
                      onChange={(e) => {
                        // Only allow numbers, max 10 digits (Egyptian mobile after +20)
                        const raw = e.target.value
                          .replace(/\D/g, "")
                          .slice(0, 10);
                        handleRecipientInfoChange(
                          "phoneNumber",
                          raw ? `+20${raw}` : ""
                        );
                      }}
              ...
              <CardContent className="space-y-4">
                ...
                {!handoverData.signature && (
                  <Alert>
                    <AlertCircle className="h-4 w-4" />
                    <AlertDescription>
                      Please obtain the recipient&apos;s digital signature
                      above.
                    </AlertDescription>
                  </Alert>
                )}
