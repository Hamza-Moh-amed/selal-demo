				...
				<CardContent>
					<div className="space-y-4">
						{filteredTransactions.map((transaction) => (
							<div
								key={transaction.id}
								className="flex flex-row justify-between gap-y-2 p-4 border rounded-lg hover:bg-gray-50"
							>
								<div className="">
								...
								<div className="">
									<p
										className={`text-end text-sm lg:text-lg font-medium ${
									...
									<p className="text-sm text-end text-muted-foreground capitalize">
